...
<body>
	...
	<header>
		<div class="container">
			<h1><a href="index.php">Kopjonstore</a></h1>
			<ul>
	...
	<div class="section">
		<div class="container">
			...
			<div class="box">
				<?php 
					$produk = mysqli_query($conn, "SELECT * FROM data_market WHERE product_status = 1 ORDER BY product_id DESC LIMIT 8");
					if(mysqli_num_rows($produk) > 0){
						while($p = mysqli_fetch_array($produk)){
				?>	
					<a href="detail-produk.php?id=<?php echo $p['product_id'] ?>">
						<div class="col-4">
							<img height="87%" src="produk/<?php echo $p['product_image'] ?>" >
