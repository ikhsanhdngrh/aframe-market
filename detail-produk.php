		...
		<div class="container">
			...
			<div class="box">
				...
				<div class="col-2">
					...
					<p><a class="btn" href="lihat-object.php?id=<?php echo $p->product_id ?>" target="_blank">
						Lihat Object 3D</a>
					</p>
					<p><a class="btn" href="marker/<?php echo $p->product_marker ?> ?>" target="_blank">  Lihat Marker
						</a>
					</p>
					</div>
				</div>
